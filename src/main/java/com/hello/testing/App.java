	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriver driver;
		 System.setProperty("webdriver.chrome.driver", "E:\\chromedriver.exe");
			...
			System.out.println("1) add a user page loaded successfully........ ");
	        else
	        {   Thread.sleep(1000);
	       ...
	       System.out.println("user added with username="+uname+" and password="+pass+" successfully......");
	       ...
	       System.out.println("*** open login page");
			...
			System.out.println("2) login page loaded successfully........ ");
	        else
	        {
	        	Thread.sleep(1000);
	       ...
	       if(result.equals("**Successful Login**"))
	      {
	       //****************** visit to home page  *********************
	          ...
	          if (namepage3.contentEquals("5. Get your Own db online"))
			     System.out.println("3)  home page loaded successfully........ ");
	          else
	          {
	        	Thread.sleep(1000);
	        	System.out.println("login page not loaded properly");
